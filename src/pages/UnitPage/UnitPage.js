                ...
                <div> 
                 ...
                 <div className="  p-5  w-full">
                    <div className="md:flex justify-between p-4">
                                    ...
                                    {typeTask.length && typeTask.map((e, i) => {
                                        return (
                                            <li key={shortid.generate()}>
                                                <a 
                                                    href={`/books/book/${book_number}/module/${module_number}/unit/${unit_number}/newTask/${e}`} className="capitalize dropdown-item text-sm py-2 px-4 font-normal block w-full whitespace-nowrap bg-transparent text-gray-700 hover:bg-gray-100"
                                                > {e} </a>
                                            </li>
                                        )
                                    }
                        ...
                        <div>
                            <h3 className="uppercase  tracking-wider md:text-xl pt-5 md:pt-0 font-bold">Libro {book_number} | Módulo {modulo_n} | Unidad {unit_number} </h3>
                        </div>
                        <div></div>
                    </div>
                                ...
                                <div className="accordion-item bg-white border border-gray-200" key={shortid.generate()}>
                                    ...
                                    >
                                        ...
                                        <div className="accordion-body py-4 px-5  ">
                                            <div className="lg:flex flex-cols justify-center lg:overflow-auto lg:space-x-4 py-3">
                                                {
                                                    data.length != 0 ? data.map((e2, i2) => {
                                                        if (e2.type === e) {
                                                            return (
                                                                <div className="lg:py-0 py-2  lg:w-1/2 ">
                                                                    <div key={shortid.generate()} className="h-full block p-6 rounded-lg shadow-lg bg-white overflow-hidden ">
                                                                        ...
                                                                        <a href={`/books/book/${book_number}/module/${module_number}/unit/${unit_number}/task/${e2._id}`} className="text-yellow-500 hover:text-yellow-600 transition duration-300 ease-in-out mb-4">Ve preguntas</a>
