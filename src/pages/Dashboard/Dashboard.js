        ...
        <div className="flex mx-auto justify-center space-y-6 my-10">
          ...
          <div>
              <div className="ml-36 hidden md:block">
                <div className="pb-10 px-40">
                  <h2 className="text-center font-extralight italic text-gray-700 text-2xl font-bold pb-5 ">BIENVENIDO AL SISTEMA DE GESTIÓN DEL MOOC DE IDIOMAS </h2>

                </div>
                <div className="text-center justify-center pl-80">
              ...
              <div className="p-5 md:hidden ">
                ...
                <div className="py-4">
                  <h2 className="text-center font-extralight italic text-gray-700 text-2xl ">GESTIONAR INFORMACIÓN  </h2>
                  <h2 className="text-center font-extralight italic text-gray-700 text-lg ">Opción disponible en una pantalla de mayores dimensiones </h2>
                </div>
